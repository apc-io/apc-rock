...
#define GPIO_SPI0_CLK_PULL_EN	BIT11
#define GPIO_SPI0_SS_PULL_EN	BIT10
#define GPIO_SPI0_MISO_PULL_EN	BIT9
#define GPIO_SPI0_MOSI_PULL_EN	BIT8
#define GPIO_SPI0_CLK_PULL_UP	BIT3
#define GPIO_SPI0_SS_PULL_UP	BIT2
#define GPIO_SPI0_MISO_PULL_UP  BIT1
#define GPIO_SPI0_MOSI_PULL_UP	BIT0

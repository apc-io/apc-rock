...
void govw_set_mif_enable(vpp_flag_t enable)
{
	switch (enable) {
...
vpp_flag_t govw_set_color_format(vdo_color_fmt format)
{
	switch (format) {
...
vdo_color_fmt govw_get_color_format(void)
{
...
void govw_set_fb_addr(U32 y_addr,U32 c_addr)
{
...
void govw_get_fb_addr(U32 * y_addr, U32 * c_addr)
{
...
void govw_get_width(U32 *width,U32 *fb_width)
{
...
int govw_mod_init(void)
{
	...
	mod_p->set_enable = govw_set_mif_enable;
	...
	mod_fb_p->set_framebuf = govw_set_framebuffer;
	mod_fb_p->set_addr = govw_set_fb_addr;
	mod_fb_p->get_addr = govw_get_fb_addr;

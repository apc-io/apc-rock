...
void ge_lock_surface(ge_info_t *geinfo, ge_surface_t *surface, void **vaddr)
{
	...
	if (surface->caps & (GSCAPS_FB | GSCAPS_GMP)) {
...
static inline void local_rgb565_to_rgb32(u_int16_t *s, u_int32_t *d)
{
	u_int16_t c;
	u_int32_t r;
	u_int32_t g;
...
static inline void local_rgb32_to_rgb565(u_int32_t *s, u_int16_t *d)
{
	u_int32_t c;
	u_int32_t r;
	u_int32_t g;

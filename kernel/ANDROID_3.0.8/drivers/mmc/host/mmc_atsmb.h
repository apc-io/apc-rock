...
#define MMC3_DRIVER_NAME "sdmmc3"
...
#define	MMC_ATSMB3_BASE				SD3_SDIO_MMC_BASE_ADDR
#define	MMC_ATMSB3_END				(SD3_SDIO_MMC_BASE_ADDR + 0x3FF)
...
/*=========================================*/
/* SD3 PDMA	related	Registers	           */
/*=========================================*/
#define	ATSMB3_PDMA_GCR		(REG32_PTR(_PDMA_GCR + MMC_ATSMB3_BASE))
#define	ATSMB3_PDMA_IER		(REG32_PTR(_PDMA_IER + MMC_ATSMB3_BASE))
#define	ATSMB3_PDMA_ISR		(REG32_PTR(_PDMA_ISR + MMC_ATSMB3_BASE))
#define	ATSMB3_PDMA_DESPR	(REG32_PTR(_PDMA_DESPR + MMC_ATSMB3_BASE))
#define	ATSMB3_PDMA_RBR		(REG32_PTR(_PDMA_RBR + MMC_ATSMB3_BASE))
#define	ATSMB3_PDMA_DAR		(REG32_PTR(_PDMA_DAR + MMC_ATSMB3_BASE))
#define	ATSMB3_PDMA_BAR		(REG32_PTR(_PDMA_BAR + MMC_ATSMB3_BASE))
#define	ATSMB3_PDMA_CPR		(REG32_PTR(_PDMA_CPR + MMC_ATSMB3_BASE))
#define	ATSMB3_PDMA_CCR		(REG32_PTR(_PDMA_CCR + MMC_ATSMB3_BASE))


/*=========================================*/
/* SD3 Register	pointer.                   */
/*=========================================*/
#define	ATSMB3_CTL			(REG8_PTR(_CTL + MMC_ATSMB3_BASE))
#define	ATSMB3_CMD_IDX		(REG8_PTR(_CMD_IDX + MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_TYPE		(REG8_PTR(_RSP_TYPE	+ MMC_ATSMB3_BASE))
#define	ATSMB3_CMD_ARG		(REG32_PTR(_CMD_ARG	+ MMC_ATSMB3_BASE))
#define	ATSMB3_BUS_MODE		(REG8_PTR(_BUS_MODE	+ MMC_ATSMB3_BASE))
#define	ATSMB3_BLK_LEN		(REG16_PTR(_BLK_LEN	+ MMC_ATSMB3_BASE))
#define	ATSMB3_BLK_CNT		(REG16_PTR(_BLK_CNT	+ MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_0		(REG8_PTR(_RSP_0 + MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_1		(REG8_PTR(_RSP_1 + MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_2		(REG8_PTR(_RSP_2 + MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_3		(REG8_PTR(_RSP_3 + MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_4		(REG8_PTR(_RSP_4 + MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_5		(REG8_PTR(_RSP_5 + MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_6		(REG8_PTR(_RSP_6 + MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_7		(REG8_PTR(_RSP_7 + MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_8		(REG8_PTR(_RSP_8 + MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_9		(REG8_PTR(_RSP_9 + MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_10		(REG8_PTR(_RSP_10 +	MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_11		(REG8_PTR(_RSP_11 + MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_12		(REG8_PTR(_RSP_12 + MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_13		(REG8_PTR(_RSP_13 +	MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_14		(REG8_PTR(_RSP_14 +	MMC_ATSMB3_BASE))
#define	ATSMB3_RSP_15		(REG8_PTR(_RSP_15 +	MMC_ATSMB3_BASE))

#define	ATSMB3_CURBLK_CNT	(REG32_PTR(_CURBLK_CNT + MMC_ATSMB3_BASE))
#define	ATSMB3_INT_MASK_0	(REG8_PTR(_INT_MASK_0 +	MMC_ATSMB3_BASE))
#define	ATSMB3_INT_MASK_1	(REG8_PTR(_INT_MASK_1 +	MMC_ATSMB3_BASE))
#define	ATSMB3_SD_STS_0		(REG8_PTR(_SD_STS_0	+ MMC_ATSMB3_BASE))
#define	ATSMB3_SD_STS_1		(REG8_PTR(_SD_STS_1	+ MMC_ATSMB3_BASE))
#define	ATSMB3_SD_STS_2		(REG8_PTR(_SD_STS_2	+ MMC_ATSMB3_BASE))
#define	ATSMB3_SD_STS_3		(REG8_PTR(_SD_STS_3	+ MMC_ATSMB3_BASE))

#define	ATSMB3_RSP_TOUT		(REG8_PTR(_RSP_TOUT	+ MMC_ATSMB3_BASE))
#define	ATSMB3_CLK_SEL		(REG8_PTR(_CLK_SEL + MMC_ATSMB3_BASE))
#define	ATSMB3_EXT_CTL		(REG8_PTR(_EXT_CTL + MMC_ATSMB3_BASE))

#define	ATSMB3_SHDW_BLKLEN	(REG16_PTR(_SHDW_BLKLEN	+ MMC_ATSMB3_BASE))
#define	ATSMB3_TIMER_VAL	(REG16_PTR(_TIMER_VAL + MMC_ATSMB3_BASE))
...
int	atsmb3_init_short_desc(unsigned long *DescAddr, unsigned	int	ReqCount,
	unsigned long *BufferAddr, int End);
